...
/**
 * 이 클래스는 학생 한 명의 이름과 과목 점수를 저장할 용도의 클래스
 * @author 이명환
 * @since 2020.03.23
 * @version v.1.0
 *
 */
public class Stud {
	// 이 클래스는 학생 한 명의 데이터이므로 학생의 이름이 있어야겠다
	String name;
	...
	*/
	...
	public Stud() {
		// 아무 데이터도 입력하지 않으면 "우현우"라는 학생의 데이터로 초기화되게 하자
//		this.kor = 100;	==> X. this() 함수 이전에 명령이 오면 에러가 난다
//		this("우현우");
		setSubj();
	}
